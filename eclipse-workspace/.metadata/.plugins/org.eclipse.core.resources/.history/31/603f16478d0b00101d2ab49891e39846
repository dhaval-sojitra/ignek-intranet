...
public class CountOfPortlet extends MVCPortlet {
	...
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		if (Validator.isBlank(countOfValue) || countOfValue.equals("Users")) {
			...
			_log.info("Total Articles:" + articles);
			...
			_log.info("Total documents:" + documents);

		} else {
			renderRequest.setAttribute("countOfValue", StringPool.BLANK);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(CountOfPortlet.class);
